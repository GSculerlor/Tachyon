...
{
    public class HoldNoteTickPiece : CompositeDrawable
    {
        /// <summary>
        /// Any tick that is not the first for a holdnote is not filled, but is instead displayed
