...
using Tachyon.Game.Rulesets.Timing;
...
namespace Tachyon.Game.Rulesets.UI.Scrolling
{
    ...
    /// </summary>
    public abstract class DrawableScrollingRuleset<TObject> : DrawableRuleset<TObject>
        where TObject : HitObject
    {
        ...
        protected DrawableScrollingRuleset(Ruleset ruleset, IBeatmap beatmap)
