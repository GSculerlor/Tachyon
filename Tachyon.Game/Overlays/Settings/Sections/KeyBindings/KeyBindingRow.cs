...
namespace Tachyon.Game.Overlays.Settings.Sections.KeyBindings
{
    public class KeyBindingRow : Container, IFilterable
    {
        ...
        private TachyonSpriteText text;
        ...
        public KeyBindingRow(object action, IEnumerable<KeyBinding> bindings)
        {
            this.action = action;
        ...
        private void load(TachyonColor colors)
        {
            ...
            {
                Radius = 2,
                Colour = colors.YellowDark.Opacity(0),
        ...
        private class CancelButton : TachyonButton
        {
            public CancelButton()
            {
                Text = "Cancel";
        ...
        private class ClearButton : TachyonButton
        {
            public ClearButton()
            {
                Text = "Clear";
        ...
        private class KeyButton : Container
        {
            ...
            public readonly TachyonSpriteText Text;
            ...
            public KeyButton(KeyBinding keyBinding)
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    Text = new TachyonSpriteText
                    {
                        Font = TachyonFont.Default.With(size: 16, weight: FontWeight.SemiBold),
